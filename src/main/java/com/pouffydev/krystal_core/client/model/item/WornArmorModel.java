package com.pouffydev.krystal_core.client.model.item;
...
public class WornArmorModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition createArmorModel(IWornArmorModelBuilder modelBuilder) {
    ...
    public interface IWornArmorModelBuilder {
