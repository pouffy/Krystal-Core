...
public class TranslatableDefinition<R, T extends R> extends Definition<R, T> {
    @Accessors(fluent = true) @Getter
    private final String customLang;

    public TranslatableDefinition(ResourceKey<R> key, String customLang) {
        super(key);
        this.customLang = customLang;
    }

    public TranslatableDefinition(ResourceKey<R> key) {
        this(key, "");
    }
